function HomeSection() {
  ...
  return (
    <section id="home" className="h-screen text-white text-center center-items flex-col xl:w-[60rem]">
      <h1 className="text-3xl md:text-4xl lg:text-5xl pb-3">
        I'm
      ...
      <h1 className="text-lg md:text-xl lg:text-2xl">I build clean, responsive websites that combine modern design with practical functionality.</h1>
    </section>
